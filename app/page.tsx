 ...
 */
const HomePage: React.FunctionComponent<HomePageProps> = React.memo(function HomePage() {
  return (
    <Container pt="lg" pb="xl">
      ...
      <Paragraph>
        Whisper Web UI is a tool that helps you transcribe voice recordings into text using the
        OpenAI Whisper transcription API. OpenAI’s Whisper API is one of quite a few APIs for
        transcribing audio, alongside the Google Cloud Speech-to-Text API, Rep.ai’s voice
        transcription APIs, Amazon Transcribe, and Microsoft Azure Speech-to-Text. It’s among the
        best for high-quality English transcriptions of standard conversational audio, based on{' '}
      ...
      <Paragraph>
        ...
        computer, this Web UI often is the easiest and fastest way to transcribe text using the
        OpenAI Whisper API.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        Whisper, an advanced speech recognition system, was trained on a vast dataset of 680,000
        hours of diverse speech data from the internet. It’s great at handling different accents,
      ...
      <Paragraph>
        All audio and transcriptions are sent securely between your device and OpenAI’s servers.
        Your OpenAI API key will also be safe: it’s stored in your browser and only sent (encrypted,
        using HTTPS) to OpenAI’s servers.
      </Paragraph>
